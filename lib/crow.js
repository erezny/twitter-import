...
module.exports = {
      withPrefix: function(str, tags) {//Decide: change period for dev, test, prod
        var metrics = new crow.MetricsRegistry({ period: 1000, separator: ".", tags: tags || {} }).withPrefix(str);
