...
function simpleUserTemplate(property_type, since_timestamp, depth){
  return {
    "order": "breadth_first",
    "return_filter": {
      "body":
...
function importUserListOwnership(){
  var checkNodeQuery = checkFriendsCount();
  var since_timestamp = 1461116903347;
  var operation = neo4j.operation('node/7307455/paged/traverse/node?pageSize=1&leaseTime=6000', 'POST', simpleUserTemplate("listOwnership",since_timestamp, 3) );
